...
class Base(object):
    ...
    def __init__(self, browser=browserName, base_url=url):
        ...
        except BaseException:  # 捕获所有异常的方方法
            logger.exception('There is a error in this file')
    ...
    def find_elements(self, locator):
        try:
            ...
            logger.exception('“' + locator[1] + '” the all Positioning faile')
    ...
    def close(self):
        try:
            self.driver.close()
            logger.info('The current page is closing')
        except BaseException:
            logger.exception('The current page failed to closing')
    ...
    def max_window(self):
        try:
            ...
            logger.exception('Maximizing the Windows fail')


    def quit(self):
        try:
            self.driver.quit()
            logger.info('The current browser is closing')
        except BaseException:
            logger.exception('The current browser is closing')
    ...
    def is_title(self, title):
        ...
        try:
            ...
            logger.exception('The url is inconsistent with the title')
    ...
    def is_title_contains(self, title):
        ...
        try:
            ...
            logger.exception(
                'The title of the url does not include ' +
                str(title))
    ...
    def is_ElementExist(self, locator):
        ...
        try:
            ...
            logger.info('The element “' + locator[1] + '” does exist')
            return True
        except BaseException:
            logger.exception('The element “' + locator[1] + '” does not exist')
    ...
    def get_text(self, locator):
        ...
        try:
            ...
            logger.exception('GET the element “' + locator[1] + '” is faile')
            return ''
